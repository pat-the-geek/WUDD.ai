...
const mdComponents = {
          ...
          p: ({ children }) => (
            <p className="font-reading text-lg text-slate-700 dark:text-slate-300 mb-4 leading-7">{children}</p>
          ),
          a: ({ href, children }) => (
            <a
              href={href}
          ...
          li: ({ children }) => <li className="font-reading text-lg text-slate-700 dark:text-slate-300 leading-relaxed">{children}</li>,
          blockquote: ({ children }) => (
