...
const SENTIMENT_COLORS = {
  positif: 'text-[var(--color-success)]',
...
export default function ClusterView({ onClose }) {
  ...
  return (
    ...
    >
      <div className="hig-modal-enter glass-panel w-full max-w-2xl max-h-[88vh] flex flex-col rounded-2xl shadow-2xl border border-white/45 dark:border-white/[0.09] overflow-hidden">
