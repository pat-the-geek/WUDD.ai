...
function StatBlock({ label, value, delta, isPercent }) {
  ...
  const color = delta > 0 ? 'text-[var(--color-success)]'
        ...
        <div className="px-5 py-4 border-b border-slate-200 dark:border-slate-700 shrink-0 bg-slate-50/60 dark:bg-slate-800/30">
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <div className="flex flex-col gap-1.5">
              <span className="text-[11px] font-semibold text-accent uppercase tracking-wider">Période 1</span>
            ...
            <button
              onClick={compare}
              disabled={loading}
              className="flex items-center gap-1.5 px-4 py-2 btn-accent text-white text-xs font-medium rounded-lg transition-colors disabled:opacity-60 self-end"
            >
