...
def api_article_full_report():
    ...
    prompt = (
        ...
        "(pas d'autre hex, pas de couleur nommée comme red/green/blue). Chaque classDef/style qui définit un fill: DOIT "
        "définir le color: apparié indiqué ci-dessous : "
        ...
        "Pour plusieurs catégories, prends les fonds dans cet ordre : #E8972E, #111111, #9A9A90, #F0A840, #FAFAF8, #5A5A52. "
        "Exemples : classDef accent fill:#E8972E,color:#111111 ; classDef fort fill:#111111,color:#FAFAF8.\n"
