...
def tool_search_entities(client: ViewerClient, *, q: str | None = None) -> dict:
    ...
    try:
        ...
        data = client.get(endpoint, params={"q": query}, timeout=client.heavy_timeout)
...
def tool_get_entity_dashboard(client: ViewerClient) -> dict:
    started_at = time.perf_counter()
